...
This project implements a distributed key-value store that ensures linearizability and fault tolerance using raft consensus algorithm. It is designed to handle network partitions, node failures and unreliable network (which can cause duplicate delivery, request / response loss) while maintaining data consistency.
...
- [Full ALR](https://github.com/ShafinKhadem/raft-kvs/tree/5a5482699aa52e828f8e6a664127cb165823658d): Read requests are processed by backup replicas after a synchronization step to ensure linearizability.
